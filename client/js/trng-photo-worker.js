...
var trngImgWorker = {
	...
	{		
		...
		var randomBitsFirstImageBinary = trngImgWorker.getLeastSigBitsFromArray(dataImageA);
		var randomBitsSecondImageBinary = trngImgWorker.getLeastSigBitsFromArray(dataImageB);

		// XOR the random bits from the two images together then run the basic Von Nuemann extractor
		var randomBitsXoredBinary = trngImgWorker.getXoredLeastSigBits(randomBitsFirstImageBinary, randomBitsSecondImageBinary);
		var randomBitsExtractedBinary = trngImgWorker.vonNeumannExtractor(randomBitsXoredBinary);
	 ...
	 * @param {type} entropyBitsImageA The least significant bits from the first image
	 * @param {type} entropyBitsImageB The least significant bits from the second image
	 ...
	 * and: https://en.wikipedia.org/wiki/Bernoulli_process#Basic_Von_Neumann_extractor
